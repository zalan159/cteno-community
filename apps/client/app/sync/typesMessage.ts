...
export type ToolCall = {
    ...
    result?: any;
    /** Backend tool_use ID, used for send-to-background RPC */
    callId?: string;
    permission?: {
        id: string;
...
export type ImageAttachment = {
    ...
    data?: string;      // base64 encoded image data (legacy inline)
    file_id?: string;   // OSS file reference (new: image stored in OSS)
    file_path?: string; // local file path (for generated images)
}
