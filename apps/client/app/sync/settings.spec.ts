...
describe('settings', () => {
    describe('settingsParse', () => {
        ...
        it('should migrate legacy compactSessionView into compactActiveSessions', () => {
            const legacySettings = {
                compactSessionView: true,
            };
            const parsed = settingsParse(legacySettings);
            expect(parsed.compactActiveSessions).toBe(true);
            expect((parsed as any).compactSessionView).toBe(true);
        });
