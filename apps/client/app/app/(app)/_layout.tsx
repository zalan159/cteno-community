    ...
    return (
        ...
        >
            ...
            <Stack.Screen
                ...
                options={{
                    headerShown: true,
                    headerTitle: t('agent.detailTitle'),
                    headerBackTitle: t('common.back'),
                }}
            />
            <Stack.Screen
...
<Stack.Screen
            ...
            <Stack.Screen
                ...
                options={{
                    headerTitle: t('settingsScheduledTasks.title'),
                }}
            />
            <Stack.Screen
