...
export default function AppearanceSettingsScreen() {
    ...
    const [compactActiveSessions, setCompactActiveSessions] = useSettingMutable('compactActiveSessions');
    ...
    return (
        <ItemList style={{ paddingTop: 0 }}>
            ...
            <ItemGroup title={t('settingsAppearance.display')} footer={t('settingsAppearance.displayDescription')}>
                <Item
                    title={t('settingsAppearance.compactActiveSessions')}
                    subtitle={t('settingsAppearance.compactActiveSessionsDescription')}
                    icon={<Ionicons name="albums-outline" size={29} color="#5856D6" />}
                    rightElement={
                        <Switch
                            value={compactActiveSessions}
                            onValueChange={setCompactActiveSessions}
                        />
                    }
                />
                <Item
