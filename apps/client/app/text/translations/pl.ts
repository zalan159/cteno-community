...
/**
 * Polish translations for the Cteno app
 * Must match the exact structure of the English translations
 */
export const pl: TranslationStructure = withEnglishFallback({
    tabs: {
    ...
    connect: {
        ...
        restoreQrStep1: '1. Otwórz Cteno na urządzeniu mobilnym',
        restoreQrStep2: '2. Przejdź do Ustawienia -> Konto',
        restoreQrStep3: '3. Kliknij „Połącz nowe urządzenie”',
        restoreQrStep4: '4. Zeskanuj ten kod QR',
    },
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'Cteno to Twój osobisty asystent AI. W pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu.',
        whatsNew: 'Co nowego',
        ...
        profiles: 'Konfiguracja modeli',
        profilesSubtitle: 'Zarzadzaj konfiguracja integracji modeli',
        skills: 'Skills',
        skillsSubtitle: 'Manage installed skills',
        mcp: 'MCP Servers',
        mcpSubtitle: 'Configure MCP tool servers',
        wechat: 'WeChat',
        connectWechatAccount: 'Połącz konto WeChat',
    ...
    settingsAppearance: {
        ...
        compactActiveSessions: 'Kompaktowy widok sesji',
        compactActiveSessionsDescription: 'Pokazuj aktywne sesje w bardziej zwartym układzie',
    },
    ...
    newSession: {
        ...
        noMachinesFound: 'Nie znaleziono maszyn. Najpierw uruchom sesję Cteno na swoim komputerze.',
        ...
        profileBuiltIn: 'Wbudowany',
        profileRequiresCliOnly: ({ required }: { required: string }) => `Ten profil używa tylko CLI ${required}`,
        profileCliNotDetected: ({ cliName }: { cliName: string }) => `Nie wykryto CLI ${cliName} (ten profil go wymaga)`,
        wizardProfileTitle: 'Wybierz profil AI',
        wizardProfileDescription: 'Wybierz backend AI dla tej sesji. Twórz własne profile dla alternatywnych API.',
        wizardMachineTitle: 'Wybierz maszynę',
        wizardDirectoryTitle: 'Wybierz katalog roboczy',
        wizardPermissionTitle: 'Tryb uprawnień',
        wizardAdvancedOptions: 'Opcje zaawansowane',
        wizardLlmProfileTitle: 'Profil LLM (agent natywny)',
        wizardLlmProfileDescription: 'Wybierz konfigurację LLM używaną przez natywnego agenta maszyny. Profilami zarządzasz w Ustawieniach.',
        cliNotDetected: ({ cliName }: { cliName: string }) => `${cliName} CLI nie wykryto`,
        dismissPopupFor: 'Nie pokazuj ponownie tego komunikatu dla',
        thisMachine: 'tej maszyny',
        anyMachine: 'dowolnej maszyny',
        installPrefix: 'Zainstaluj',
        viewInstallationGuide: 'Zobacz instrukcję instalacji →',
        installGeminiCli: 'Zainstaluj Gemini CLI, jeśli jest dostępne',
        viewGeminiDocs: 'Zobacz dokumentację Gemini →',
        duplicate: 'Duplikuj',
        searchMachinesPlaceholder: 'Wpisz, aby filtrować maszyny...',
        recentMachinesTitle: 'Ostatnie maszyny',
        favoriteMachinesTitle: 'Ulubione maszyny',
        noMachinesAvailable: 'Brak dostępnych maszyn',
        searchDirectoriesPlaceholder: 'Wpisz, aby filtrować lub podaj własny katalog...',
        recentDirectoriesTitle: 'Ostatnie katalogi',
        favoriteDirectoriesTitle: 'Ulubione katalogi',
        noRecentDirectories: 'Brak ostatnich katalogów',
        permissionDesc: {
            askForPermissions: 'Pytaj o uprawnienia',
            readOnlyMode: 'Tryb tylko do odczytu',
            workspaceWriteWithApproval: 'Zapis w workspace z zatwierdzeniem',
            fullAccessSkipPermissions: 'Pełny dostęp, pomijaj uprawnienia',
            autoApproveEdits: 'Automatycznie zatwierdzaj edycje',
            planBeforeExecuting: 'Planuj przed wykonaniem',
            skipAllPermissions: 'Pomijaj wszystkie uprawnienia',
        },
        sessionType: {
            title: 'Typ sesji',
            simple: 'Prosta',
    ...
    server: {
        ...
        notValidHappyServer: 'To nie jest prawidłowy serwer',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Proszę zaktualizować do najnowszej wersji',
        ...
        switchedToProfile: ({ name }: { name: string }) => `Przełączono na ${name}`,
        failedToSwitchProfile: 'Nie udało się przełączyć profilu',
        switchLlmProfileTitle: 'Przełącz profil LLM',
        switchLlmProfileMessage: 'Wybierz profil dla tej sesji:',
        llmProfile: 'Profil LLM',
    ...
    components: {
        emptyMainScreen: {
            ...
            readyToCode: 'Gotowy do uruchomienia asystenta AI?',
            installCli: 'Rozpocznij nową sesję',
            runIt: 'Uruchom je',
    ...
    machineLauncher: {
        ...
        removeFavoriteMessage: ({ item, section }: { item: string; section: string }) =>
            `Usunąć "${item}" z ${section}?`,
        removeFavoriteConfirm: 'Usuń',
    },
    ...
    settingsAccount: {
        ...
        deleteAccountConfirm: 'To trwale usunie Twoje konto i wszystkie powiązane dane, w tym rozmowy, ustawienia i historię płatności. Tej operacji nie można cofnąć.',
        deleteAccountFinalTitle: 'Czy jesteś całkowicie pewien?',
        deleteAccountFinalConfirm: 'Twoje konto i wszystkie dane zostaną trwale usunięte. Nie można tego cofnąć.',
        deleteAccountFinalButton: 'Usuń na zawsze',
    },
    ...
    settingsScheduledTasks: {
        ...
        subtitle: 'Zarzadzaj zadaniami czasowymi i cyklicznymi',
        noMachineAvailable: 'Brak dostepnej maszyny',
        emptyTitle: 'Brak zaplanowanych zadan',
        emptySubtitle: 'W rozmowie mozesz powiedziec Cteno co ma zrobic i kiedy',
        details: 'Szczegoly',
        enable: 'Wlacz',
        disable: 'Wylacz',
        enabled: 'Wlaczone',
        ...
        disabled: 'Wylaczone',
        oneTime: 'Jednorazowe',
        errors: ({ count }: { count: number }) => `Bledy: ${count}`,
        ok: 'OK',
        fail: 'BLAD',
        runCount: ({ count }: { count: number }) => `${count} uruchomien`,
        scheduleOnce: ({ time }: { time: string }) => `Raz: ${time}`,
        everySeconds: ({ count }: { count: number }) => `Co ${count} s`,
        everyMinutes: ({ count }: { count: number }) => `Co ${count} min`,
        everyHours: ({ count }: { count: number }) => `Co ${count} h`,
        everyDays: ({ count }: { count: number }) => `Co ${count} dzien`,
        scheduleCron: ({ expr }: { expr: string }) => `Cron: ${expr}`,
        overdue: 'Po terminie',
        nextUnderMinute: 'Nastepne: <1 min',
        nextMinutes: ({ count }: { count: number }) => `Nastepne: ${count} min`,
        nextHours: ({ count }: { count: number }) => `Nastepne: ${count} h`,
        nextAt: ({ time }: { time: string }) => `Nastepne: ${time}`,
        ...
        executionStats: 'Statystyki wykonania',
        totalRuns: 'Laczna liczba uruchomien',
        lastStatus: 'Ostatni status',
        lastRun: 'Ostatnie uruchomienie',
        nextRun: 'Nastepne uruchomienie',
        consecutiveErrors: 'Kolejne bledy',
        lastResult: 'Ostatni wynik',
        none: '-',
        cronExpression: 'Wyrazenie cron',
        cronPlaceholder: '* * * * *',
        deleteAfterRun: 'Usun po wykonaniu',
        yesAutoDelete: 'Tak',
        noRecurring: 'Nie',
        scheduleOneTime: ({ time }: { time: string }) => `Jednorazowo: ${time}`,
        seconds: ({ count }: { count: number }) => `${count} sekund`,
        minutes: ({ count }: { count: number }) => `${count} minut`,
        hours: ({ count }: { count: number }) => `${count} godzin`,
        days: ({ count }: { count: number }) => `${count} dni`,
        interval: 'Interwal',
        unitMin: 'Min',
        unitHr: 'Godz',
        unitDay: 'Dzien',
        runAtIso: 'Uruchom o (ISO 8601)',
        runAtIsoPlaceholder: '2026-03-01T09:00:00',
        cronDaily: 'Codziennie',
        cronWeekly: 'Co tydzien',
        cronMonthly: 'Co miesiac',
        cronCustom: 'Wlasne',
        time: 'Czas',
        date: 'Data',
        dayOfWeek: 'Dzien tygodnia',
        dayOfMonth: 'Dzien',
        dayOfMonthSuffix: 'kazdego miesiaca',
        runAt: 'Uruchom o',
        dowSun: 'Nd',
        dowMon: 'Pn',
        dowTue: 'Wt',
        ...
        scheduleRecurring: ({ interval, anchor }: { interval: string; anchor: string }) =>
            `Cykliczne: co ${interval}${anchor ? ` (punkt odniesienia: ${anchor})` : ''}`,
        saving: 'Zapisywanie...',
        edit: 'Edytuj',
        confirm: 'Potwierdzic?',
        close: 'Zamknij',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem Cteno. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
    ...
    oauth: {
        connectService: ({ service }: { service: string }) => `Połącz ${service}`,
    ...
    welcome: {
        ...
        wechatLogin: 'Zaloguj przez WeChat',
    ...
    skills: {
        ...
        clearAll: 'Clear All',
        addSkill: 'Add Skill',
        manualAdd: 'Utwórz ręcznie',
        skillStore: 'Sklep umiejętności',
    ...
    profiles: {
        ...
        subtitle: 'Zarzadzaj konfiguracja integracji modeli',
        ...
        noMachineConnected: 'Brak podłączonej maszyny',
        storageHint: 'Profile LLM są przechowywane na maszynie. Każda sesja może używać innego profilu.',
        failedToSave: 'Nie udało się zapisać profilu',
        failedToDelete: 'Nie udało się usunąć profilu',
        cannotDelete: 'Nie można usunąć profilu',
