...
license: MIT
when_to_use: "Use when the user asks to create, read, analyze, modify, validate, or format any Excel/spreadsheet file, including .xlsx, .xlsm, .csv, .tsv, financial models, formulas, or pivot-table style data."
tags:
  - xlsx
  - excel
  - spreadsheet
