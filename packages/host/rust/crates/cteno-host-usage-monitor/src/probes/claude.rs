...
//! haiku pings/hour, which is trivially cheap compared to actual usage.

use async_trait::async_trait;
use serde_json::{json, Value};

use crate::probe::VendorUsageProbe;
use crate::store::{UsageWindow, VendorId, VendorUsage};
...
#[async_trait]
impl VendorUsageProbe for ClaudeProbe {
    ...
    async fn poll(&self) -> Result<VendorUsage, String> {
        let creds = match load_credentials() {
            ...
            Err(e) => {
                ...
                return Ok(VendorUsage::error(VendorId::Claude, e));
            }
        };
        ...
        if !status.is_success() {
            ...
            return Ok(VendorUsage::error(VendorId::Claude, msg));
        }
...
fn extract_window(headers: &reqwest::header::HeaderMap, claim: &str) -> Option<UsageWindow> {
